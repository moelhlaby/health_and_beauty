...
class AppPreferences {
  ...
  Future<void> setTheme(String value) {
    return _prefs.setString('theme', value);
  }
  ...
  Future<void> setAccessToken(String value) {
    return _prefs.setString(ApiConstant.appTokenKey, value);
  }

  String? getAccessToken() {
    return _prefs.getString(ApiConstant.appTokenKey);
  }
